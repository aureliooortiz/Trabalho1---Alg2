...
ssize_t buscaSequencialIt(int v[], size_t a, size_t b,
							int x, uint64_t *comp){
	for(int i = a; i < b; i++){
		(*comp)++;
		if(x < v[i]){
...
ssize_t buscaSequencialRecursiva(int v[], size_t a, size_t b, 
				int x, uint64_t *comp){
	if(a == b){
		return a;
	}
...
ssize_t buscaBinariaIt(int v[], size_t a, size_t b, 
					int x, uint64_t *comp){
	ssize_t m;
...
ssize_t buscaBinariaRecursiva(int v[], size_t a, size_t b,
								int x, uint64_t *comp){
	ssize_t m;
...
void inserir(int v[], size_t a, size_t b, uint64_t *comp){
	ssize_t j, i;
...
void insertionSortIt(int v[], size_t a, size_t b, uint64_t *comp){
	int k;
...
void insertionSortRecursivo(int v[], size_t a, size_t b,
								uint64_t *comp){
	if(a == b){
		return;
	}
...
ssize_t minimoVetIt(int v[], size_t a, size_t b,
						uint64_t *comp){
	size_t m, i;
...
void selectionSortIt(int v[], size_t a, size_t b,
						uint64_t *comp){
	size_t k;
...
ssize_t minimoVetRec(int v[], size_t a, size_t b,
						uint64_t *comp){
	size_t m;
...
void selectionSortRecursivo(int v[], size_t a, size_t b,
								uint64_t *comp){
	if(a >= b){
		return;
	}
...
void copiar(int v[], size_t a, size_t b, int aux[]){
	size_t i, j;
...
void merge(int v[], size_t a, size_t m, 
...
void merge_sort(int v[], size_t a, size_t b,
					uint64_t *comp){
	size_t m;
